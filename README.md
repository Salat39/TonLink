...
Клиент живёт в системе как VPN-клиент и транслирует серверное подключение. То есть если сервер работает через VPN -> клиенту передаётся это VPN-подключение.
